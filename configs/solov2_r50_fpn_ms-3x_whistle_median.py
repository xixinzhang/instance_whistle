...
launcher = 'none'
load_from = 'checkpoints/solov2_r50_fpn_3x_coco_20220512_125856-fed092d4.pth'
log_level = 'INFO'
...
optim_wrapper = dict(
    ...
    optimizer=dict(lr=0.01/8, momentum=0.9, type='SGD', weight_decay=0.0001),
    type='OptimWrapper')
param_scheduler = [
    dict(
        begin=0,
...
work_dir = './work_dirs/solov2_r50_fpn_ms-3x_coco_median'
